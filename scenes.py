...
class MainMenu(gamelib.MenuScene):
    def __init__(self, director=None, buttons=None, background=None, music=None):
        ...
        playButton = gamelib.MainMenuButton(self, {'click': ['loadScene', 1]}, (wCenter, hCenter - 150, 300, 100), 'PLAY')
        optionsButton = gamelib.MainMenuButton(self, None, (wCenter, hCenter, 300, 100), 'OPTIONS')
        quitButton = gamelib.MainMenuButton(self, None, (wCenter, hCenter + 150, 300, 100), 'QUIT')
